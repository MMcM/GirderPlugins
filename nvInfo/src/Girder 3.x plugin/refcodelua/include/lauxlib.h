...
LUALIB_API void luaL_closelib(lua_State *L, const struct luaL_reg *l, int n); // added by Ron Bessems 6 October 2002.
...
#define luaL_closel(L,a)		luaL_closelib(L, a, (sizeof(a)/sizeof(a[0])))
