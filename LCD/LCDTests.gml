...
-->
<Girder Version="400">
  <FileRoot Name="C:\Program Files\Promixis\Girder\plugins\LCD\LCDTests.gml" Identifier="0" Enabled="TRUE" FileGUID="{C94C17F9-8E25-4615-80AD-94F20257BB45}" TimeStamp="0" Locked="FALSE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
...
abcdefghijklmnopqrstuvwxyz
      ...
      <Command Name="Start Timer" Identifier="13" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
        <OSD>FALSE</OSD>
        <Topmost>TRUE</Topmost>
        <MatchNum>1</MatchNum>
        ...
        <iValue2>2</iValue2>
        <lValue3>4</lValue3>
        <FileGUID3>{C94C17F9-8E25-4615-80AD-94F20257BB45}</FileGUID3>
...
ðñòóôõö÷øùúûüýþÿ</sValue1>
    ...
    <Group Name="GPO" Identifier="114" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
      ...
      <Command Name="Start Counter" Identifier="116" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
        <OSD>FALSE</OSD>
        <Topmost>TRUE</Topmost>
        <MatchNum>1</MatchNum>
        <bValue1>TRUE</bValue1>
...
AddFanSensor(1, 1, 23).failsafeTemp = 30
        ...
        <Command Name="Enable Event" Identifier="124" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
          ...
          <bValue3>FALSE</bValue3>
          <lValue1>126</lValue1>
          <FileGUID1>{C94C17F9-8E25-4615-80AD-94F20257BB45}</FileGUID1>
          <ActionType>4</ActionType>
          <ActionSubType>1</ActionSubType>
        </Command>
        <Command Name="Start Timer" Identifier="125" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
...
if entry then
  ...
  entry:CheckTemp()
      ...
      <MultiGroup Name="Disable Feedback" Identifier="129" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
        ...
        <Command Name="Disable Event" Identifier="132" Enabled="TRUE" ErrorBreak="FALSE" ErrorJump="FALSE" ErrorEmail="FALSE" ErrorGirderLog="FALSE" ErrorSystemLog="FALSE">
