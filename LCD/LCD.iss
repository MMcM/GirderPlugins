...
SourceDir=..\..
UninstallDisplayName=Girder LCD 4.3
...
Name: "pertelian"; Description: "Pertelian Displays"; Types: full
...
Source: "pertelian.dll"; DestDir: "{app}"; Components: pertelian; Flags: promptifolder
