...
static MatchEntry g_matches[] = {
  ...
  BEGIN_MODULE(PowerDVD)
    ...
    BEGIN_NMATCH(OSD)
      ...
      ENTRY_STR(MATCH_CLASS, "OSD Window Class")
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(4,2))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
    ...
    BEGIN_NMATCH(OSD.2)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
      ENTRY_STR(MATCH_CLASS, "OSD Window Class")
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(4,20))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
    ...
    BEGIN_NMATCH(OSD.3)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
      ENTRY_STR(MATCH_CLASS, "OSD Window Class")
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(4,40))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
  ...
  BEGIN_MODULE(MyHD)
    BEGIN_NMATCH(Channel)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(25,62))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
    ...
    BEGIN_NMATCH(File)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
     ENTRY_NUM(MATCH_WPARAM, MAKELONG(35,62))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
    ...
    BEGIN_NMATCH(Elapsed)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(25,82))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
    ...
    BEGIN_NMATCH(Shift)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(195,63))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()

    BEGIN_NMATCH(CPChannel)
      ENTRY_NUM(MATCH_PATCH, PATCH_TEXTIMAGE)
      ENTRY_NUM(MATCH_WPARAM, MAKELONG(55,36))
     BEGIN_EXTRACT()
      ENTRY0(EXTRACT_LPARAM_STR)
    END_MATCH()
